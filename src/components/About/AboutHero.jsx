    ...
    <section id="about-hero" className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-32 text-center">
        ...
        <p className="text-gray-400 mt-6 max-w-2xl mx-auto text-lg">
          We are dedicated to empowering businesses with innovative technology solutions and expert business consulting. We partner with companies of all sizes to drive digital transformation, enhance productivity, and achieve sustainable growth through strategic guidance and cutting-edge technology.
        </p>
